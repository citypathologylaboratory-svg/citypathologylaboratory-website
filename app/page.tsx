      ...
      <section className="py-16 bg-primary-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <a href="/tests" className="bg-primary-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-700 transition inline-block">
              View All Tests
            </a>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <a href="/contact" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary-600 transition">
              Contact Us
            </a>
          </div>
        </div>
